                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AZZURE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AZZURE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Azzure: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AZZURE Core"), this);
    aboutAction->setStatusTip(tr("Show information about AZZURE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AZZURE"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AZZURE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AZZURE addresses"));
    ...
    openAction->setStatusTip(tr("Open a AZZURE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AZZURE Core help message to get a list with possible AZZURE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AZZURE Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AZZURE network", "", count));
}
...
{
    QString strTitle = tr("AZZURE Core"); // default title
